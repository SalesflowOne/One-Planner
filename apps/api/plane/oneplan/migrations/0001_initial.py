# Generated manually for OnePlan initial schema
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "mode",
                    models.CharField(
                        choices=[("ask", "Ask"), ("plan", "Plan"), ("act", "Act")], default="ask", max_length=20
                    ),
                ),
                (
                    "created_by",
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="oneplan_aiconversation",
                        to="db.workspace",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="oneplan_objective",
                        to="db.workspace",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("provider", models.CharField(choices=[("supabase", "Supabase")], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("kpi_target", models.CharField(blank=True, max_length=255)),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="owned_constraints",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="oneplan_constraint",
                        to="db.workspace",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("pre_state", models.JSONField(blank=True, null=True)),
                (
                    "status",
                    models.CharField(
                        choices=[
                ...
                ("preview_id", models.UUIDField(blank=True, db_index=True, null=True)),
                (
                    "approved_by",
                    models.ForeignKey(
                        blank=True,
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="oneplan_aiactionlog",
                        to="db.workspace",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("default_mode", models.CharField(default="ask", max_length=20)),
                (
                    "created_by",
                    models.ForeignKey(
                        null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("external_org_id", models.CharField(db_index=True, max_length=255)),
